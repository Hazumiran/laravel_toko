        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5>Pesanan anda sudah berhasil dipesan, silahkan melakukan pembayaran dengan cara transfer ke rekening <strong>Bank BSI No.Rek : 43345-621911-166</strong> sebesar : <strong>Rp. {{ number_format($pesanan->kode+$pesanan->jumlah_harga) }}</strong></h5>
                </div>
            </div>
            <div class="card mt-2">
                <div class="card-body">
